        ...
        <section class="whiteSection full-width clearfix productsSection">
            <div class="container">
                ...
                <div class="sectionTitle text-center">
                    ...
                    <ol class="breadcrumb">
                        <li v-if="isSelectedCategory || isSelectedProduct">
                            <a href="javascript:void(0)" @click="onSelectGroup">
                                <i class="fa fa-th"></i> หมวดหมู่
                            </a>
                        </li>
                ...
                <div class="product-grid container-fluid">
                    <div class="padding-v-sm">
                        ...
                        <div class="tab-content product-grid-tab" id="pills-tabContent">
                            <div class="tab-pane fade active in" id="pills-all" role="tabpanel"
                                ...
                                <!-- product -->
                                <div v-if="loading" class="loading hidden">
                                    <div class="lds-dual-ring" id="loading2"></div>
                                </div>
                                <div v-show="isSelectedCategory && !isSelectedProduct" class="row">
                                    <div v-for="(product, key) in products" :key="key" class="col">
                                        <div class="media open-collapse">
                                            <a @click="onSelectProduct(product.product_id)" href="javascript:void(0)"
                                               class="product-link product-cate-sub">
                                                <div class="product-sub">
                                                    <img
                                                            :src="product.image_url"
                                                            :data-src="product.image_url"
                                                            :data-srcset="product.image_url"
                                                            alt="imgae"
                                                            class="img-fluid img-responsive center-block lazy">
                                                </div>
                ...
                <!--begin:Form-->
                <div v-show="step === 1 && isSelectedProduct" class="row" id="form-container">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="container-form hidden">
                                            ...
                                            <form v-if="formOptions" v-on:submit.prevent="onSubmit" id="form-quotation">
                                                ...
                                                <span v-if="isvisibleInput('paper_size_id') && formAttributes.paper_size_id === 'custom'"
                                                      class="label label-option custom-paper-size hidden">
                                                ...
                                                <v-row v-if="isvisibleInput('paper_size_id')  && formAttributes.paper_size_id === 'custom'">
                                                    <!-- กว้าง -->
                                                    <v-col v-show="isvisibleInput('paper_size_width')" xs="12" sm="3"
                                                           md="3">
                                                    ...
                                                    <!-- ยาว -->
                                                    <v-col v-show="isvisibleInput('paper_size_lenght')" xs="12" sm="3"
                                                           md="3">
                                                    ...
                                                    <!-- สูง -->
                                                    <v-col v-show="isvisibleInput('paper_size_height')" xs="12" sm="3"
                                                           md="3">
                                                    ...
                                                    <!-- หน่วย -->
                                                    <v-col v-show="isvisibleInput('paper_size_unit')" xs="12" sm="3"
                                                           md="3">
                                                ...
                                                <v-row v-if="isvisibleInput('paper_id')">
                                                    <v-col xs="12" sm="6" md="6">
                                                        <div v-bind:class="['form-group', errors.first('paper_id') ? 'has-error' : 'has-success']">
                                                            <!-- กระดาษ -->
                                                            <label v-if="isvisibleInput('paper_id')"
                                                                   class="control-label">
                                                                กระดาษ
                                                            </label>
                                                            <v-select2
                                                ...
                                                <v-row v-if="isvisibleInput('bill_detail_qty')">
                                                    <v-col v-if="isvisibleInput('bill_detail_qty')" xs="12" sm="6"
                                                           md="6">
                                                ...
                                                <v-row v-if="isvisibleInput('coating_id')">
                                                    ...
                                                    <v-col v-show="formAttributes.coating_id && formAttributes.coating_id !== 'N'"
                                                           xs="12" sm="6" md="6">
                                                ...
                                                <v-row v-if="isvisibleInput('diecut') && isDicut">
                                                    ...
                                                    <v-col v-if="isvisibleInput('diecut') && formAttributes.diecut === 'Curve'"
                                                           xs="12" sm="6" md="6">
                    ...
                    <div class="col-md-5 col-lg-4">
                        ...
                        <div ref="product_detail" class="panel panel-info product-panel">
                            <div class="panel-body">
                                ...
                                <div v-if="productData && formOptions" class="product-detail hidden">
