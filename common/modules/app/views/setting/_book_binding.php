    ...
    <div class="box-body">
        <?= GridView::widget([
            ...
            'panel' => [
                'heading' => false,
                'type' => 'default',
                'before' => Html::a(Icon::show('plus') . 'เพิ่มรายการ', ['create-book-binding'], [
            ...
            'toolbar' => [
                [
                    'content' => Html::a(Icon::show('refresh'), ['book-binding'], [
            ...
            'columns' => [
                ...
                [
                    ...
                    'buttons' => [
                        'delete' => function ($url, $model, $key) {
                            return Html::a(Icon::show('trash', ['framework' => Icon::BSG]), $url, [
                                ...
                                'data-method' => 'post',
                                'data-pjax-reload' => '#grid-book-binding-pjax',
                                'data-toggle' => 'tooltip'
                            ]);
                        },
                    ],
                    'urlCreator' => function ($action, $model, $key, $index) {
                        if ($action == 'update') {
                            return Url::to(['update-book-binding', 'id' => $key]);
                        }
                        if ($action == 'delete') {
                            return Url::to(['delete-book-binding', 'id' => $key]);
                        }
                    }
                ]
            ],
