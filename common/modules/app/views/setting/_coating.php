    ...
    <div class="box-body">
        <?= GridView::widget([
            ...
            'panel' => [
                'heading' => false,
                'type' => 'default',
                'before' => Html::a(Icon::show('plus') . 'เพิ่มรายการ', ['create-coating'], [
            ...
            'toolbar' => [
                [
                    'content' => Html::a(Icon::show('refresh'), ['coating'], [
            ...
            'columns' => [
                ...
                [
                    ...
                    'buttons' => [
                        'delete' => function ($url, $model, $key) {
                            return Html::a(Icon::show('trash', ['framework' => Icon::BSG]), $url, [
                                ...
                                'data-method' => 'post',
                                'data-pjax-reload' => '#grid-coating-pjax',
                                'data-toggle' => 'tooltip'
                            ]);
                        },
                    ],
                    'urlCreator' => function ($action, $model, $key, $index) {
                        if ($action == 'update') {
                            return Url::to(['update-coating', 'id' => $key]);
                        }
                        if ($action == 'delete') {
                            return Url::to(['delete-coating', 'id' => $key]);
                        }
                    }
                ]
            ],
