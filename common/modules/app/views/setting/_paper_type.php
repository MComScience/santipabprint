    ...
    <div class="box-body">
        <?= GridView::widget([
            ...
            'panel' => [
                'heading' => false,
                'type' => 'default',
                'before' => Html::a(Icon::show('plus') . 'เพิ่มรายการ', ['create-paper-type'], [
            ...
            'columns' => [
                ...
                [
                    ...
                    'buttons' => [
                        'delete' => function ($url, $model, $key) {
                            return Html::a(Icon::show('trash', ['framework' => Icon::BSG]), $url, [
                                ...
                                'data-method' => 'post',
                                'data-pjax-reload' => '#grid-paper-type-pjax',
                                'data-toggle' => 'tooltip'
                            ]);
                        },
                    ],
                    'urlCreator' => function ($action, $model, $key, $index) {
                        if ($action == 'update') {
                            return Url::to(['update-paper-type', 'id' => $key]);
                        }
                        if ($action == 'delete') {
                            return Url::to(['delete-paper-type', 'id' => $key]);
                        }
                    }
                ]
            ],
