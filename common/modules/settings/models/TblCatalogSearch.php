...
use common\modules\settings\models\TblCatalog;

/**
 * TblCatalogSearch represents the model behind the search form of `common\modules\settings\models\TblCatalog`.
 */
