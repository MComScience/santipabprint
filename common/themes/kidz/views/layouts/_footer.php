...
<footer>
    ...
    <div class="footerInfoArea full-width clearfix"
         style="background-image: url(<?= $themeAsset ?>/img/footer/footer-bg-1.png);">
        <div class="container">
            <div class="row">
                <div class="col-sm-3 col-xs-12">
                    <div class="footerTitle">
                        <a href="index.html"><img src="<?= Yii::getAlias('@web/images/santipab_logo.png') ?>"></a>
                    </div>
                    <div class="footerInfo">
                        <p> บริษัท สันติภาพแพ็คพริ้นท์ จำกัด 214-216 ถนนแก้วนวรัฐ ต.วัดเกต อ.เมือง จ.เชียงใหม่ 50000</p>
                        <p> โทร : 053-248657-8</p>
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h5 class="media-heading"><a href="single-blog.html">A Clean Website Gives More
                                                Experience To The Visitors</a></h5>
                                        <p>July 7 - 2016</p>
                                    </div>
                                </div>
                            </li>
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h5 class="media-heading"><a href="single-blog-left-sidebar.html">A Clean
                                                Website Gives More Experience To The Visitors</a></h5>
                                        <p>July 7 - 2016</p>
                                    </div>
                                </div>
                            </li>
            ...
            <div class="row">
                ...
                <div class="col-sm-7 col-sm-pull-5 col-xs-12">
                    <div class="copyRightText">
                        <p>© 2018 Copyright บริษัท สันติภาพแพ็คพริ้นท์ จำกัด  by <a href="https://github.com/MComScience">Tanakorn ComScience</a>.</p>
                    </div>
                </div>
            </div>
        </div>
