...
class NumberThai extends Component {
...
// arabicToThaiNumber
     ...
     */
    public function convertBaht($num = 0, $display_net = true) {
...
// thaiToArabicNumber
    ...
    public function Convert($amount_number) {
        $input = strval($amount_number);
        $inputConvert = str_replace($this->thai_number, $this->arabic_number, $input);
        $number = str_replace(',', '', $inputConvert);
        $amount_number = number_format($number, 2, ".", "");
