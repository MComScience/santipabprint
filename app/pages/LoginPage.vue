<template>
  <div>
    ...
    <div class="form-horizontal" v-else>
      ...
      >
        <label for="loginform-username" class="col-lg-1 control-label"
          >Username</label
        >
        <div class="col-lg-3">
          <input
      ...
      >
        <label for="loginform-password" class="col-lg-1 control-label"
          >Password</label
        >
        <div class="col-lg-3">
          <input
      ...
      <div class="col-lg-offset-1" style="color:#999;">
        You may login with <strong>admin/admin</strong> or
