(function($) {
  ...
  $form.on("beforeSubmit", function() {
    var paperSizeKeys = $("#grid-paper-size").yiiGridView("getSelectedRows"),
      printOnePageKeys = $("#grid-print-one-page").yiiGridView(
        "getSelectedRows"
      ),
      printTwoPageKeys = $("#grid-print-two-page").yiiGridView(
        "getSelectedRows"
      ),
    ...
    var $btn = $("#" + $form[0].id + ' button[type="submit"]').button(
      "loading"
    );
    $.ajax({
      ...
      data: $.extend(formData, {
        ...
        printOnePageKeys: printOnePageKeys,
        printTwoPageKeys: printTwoPageKeys,
        paperKeys: paperKeys,
